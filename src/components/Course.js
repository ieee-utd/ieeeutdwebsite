...
export default function Course(props) {
    ...
    return (
        <div className="tw-flex tw-flex-col tw-bg-white tw-rounded-lg p-4 m-4 tw-w-[90vw]">
            ...
            {Object.entries(props.tutors).map(([tutor, times]) => {
                console.log("Tutor: ", tutor, "Times: ", times)
                return (
                    <div className="tw-flex tw-flex-col tw-p-4 tw-bg-fadedblue tw-rounded-lg tw-my-4">
