  ...
  return (
    <div>
      ...
      <div className={styles.description}>
        Plan and market upcoming events, moderate the social media accounts, and
      ...
      <div className={styles.description}>
        Engineer projects for solutions to real-world problems faced by the UT
        Dallas community, designed, built, tested, and used by UTD students,
        faculty and staff
      </div>
